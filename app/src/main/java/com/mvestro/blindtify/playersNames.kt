    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnValidateNames.setOnClickListener {
            if (editTxtP1Name.text.toString() != "" && editTxtP2Name.text.toString() != "" && editTxtP3Name.text.toString() != "" && editTxtP4Name.text.toString() != "") {
                com.mvestro.blindtify.Model.Game.P1Name = editTxtP1Name.text.toString()
                com.mvestro.blindtify.Model.Game.P2Name = editTxtP2Name.text.toString()
                com.mvestro.blindtify.Model.Game.P3Name = editTxtP3Name.text.toString()
                com.mvestro.blindtify.Model.Game.P4Name = editTxtP4Name.text.toString()
